...
def test_build_version_info__2(self) -> None:
        ...
        exp = _VersionInfo(
            ...
            minor=_VersionPart(
                pos=1, txt="6b2", num=6, pre_txt="b", pre_num=2, name="minor"
            ),
            patch=_VersionPart(
...
def test_build_version_info__3(self) -> None:
        ...
        exp = _VersionInfo(
            ...
            minor=_VersionPart(
                pos=1, txt="10", num=10, pre_txt="", pre_num=-1, name="minor"
            ),
            patch=_VersionPart(
                pos=2, txt="1a4", num=1, pre_txt="a", pre_num=4, name="patch"
            ),
            pre_pos=2,
        )
        strict_version_obj = Mock(spec=StrictVersion)
