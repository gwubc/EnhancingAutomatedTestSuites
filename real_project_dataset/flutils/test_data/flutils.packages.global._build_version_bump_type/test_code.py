def test_build_version_bump_type__1(self) -> None:
        ...
        for args, exp in values:
            kwargs = {"position_positive": args[0], "pre_release": args[1], "exp": exp}
...
_build_version_bump_type({position_positive!r}, {pre_release!r})
...
def test_build_version_bump_type__2(self) -> None:
        values: List[Tuple[int, str]] = [(0, "a"), (0, "b"), (1, "c"), (2, "c")]
        for args in values:
            kwargs = {"position_positive": args[0], "pre_release": args[1]}
            with self.subTest(**kwargs):
